...
@Service
public class TreasuryValidatorOpi18Service implements TreasuryValidatorService<FlussoGiornaleDiCassa> {
    ...
    public List<TreasuryErrorDTO> validateData(FlussoGiornaleDiCassa fGC, String fileName) {
        ...
        fGC.getInformazioniContoEvidenza().forEach(informazioniContoEvidenza ->
                informazioniContoEvidenza.getMovimentoContoEvidenzas().forEach(movimentoContoEvidenza -> {
                    ...
                    codEsercizio = !fGC.getEsercizio().isEmpty() ? fGC.getEsercizio().getFirst().toString() : codEsercizio;
                    if (fGC.getEsercizio() == null || fGC.getEsercizio().isEmpty())
