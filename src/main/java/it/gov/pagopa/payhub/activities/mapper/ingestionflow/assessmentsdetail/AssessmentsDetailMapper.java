...
public class AssessmentsDetailMapper {
    ...
    public AssessmentsDetailRequestBody map2AssessmentsDetailRequestBody(AssessmentsIngestionFlowFileDTO dto, Long organizationId, Long assessmentId) {

        byte [] cfDebtorHash = AESUtils.encrypt(this.dataCipherPsw, dto.getDebtorFiscalCode());
