...
@Service
public class TreasuryValidatorOpi171Service implements TreasuryValidatorService<FlussoGiornaleDiCassa> {
    ...
    public List<TreasuryErrorDTO> validateData(FlussoGiornaleDiCassa fGC161, String fileName) {
        ...
        fGC161.getInformazioniContoEvidenza().forEach(informazioniContoEvidenza ->
                informazioniContoEvidenza.getMovimentoContoEvidenzas().forEach(movimentoContoEvidenza -> {
                    ...
                    codEsercizio = !fGC161.getEsercizio().isEmpty() ? fGC161.getEsercizio().getFirst().toString() : codEsercizio;
