 ...
 */
@ActivityInterface
public interface DeleteSendNotificationFileActivity {

    /**
     * delete send notification expired files process.
     *
     * @param sendNotificationId the ID of send notification
     * @return the OffsetDateTime of the next schedule
     */
    @ActivityMethod
    OffsetDateTime deleteSendNotificationExpiredFiles(String sendNotificationId);
