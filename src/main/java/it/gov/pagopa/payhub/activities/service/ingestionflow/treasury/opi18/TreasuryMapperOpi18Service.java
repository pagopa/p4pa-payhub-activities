...
@Service
public class TreasuryMapperOpi18Service implements TreasuryMapperService<FlussoGiornaleDiCassa> {
    @Override
    public Map<TreasuryOperationEnum, List<Treasury>> apply(FlussoGiornaleDiCassa fGC, IngestionFlowFile ingestionFlowFile) {
