...
public class RestInvokeConflictException extends ConflictException implements RestInvokeHttpClientException {
  ...
  public RestInvokeConflictException(String applicationName, HttpStatus  httpStatus, String category, String code, String message, List<PuErrorDTO.ErrorFieldDTO> fields) {
