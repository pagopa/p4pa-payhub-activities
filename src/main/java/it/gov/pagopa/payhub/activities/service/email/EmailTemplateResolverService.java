...
public class EmailTemplateResolverService {
    ...
    public EmailTemplate resolve(EmailTemplateName templateName) {
        return switch (templateName){
            ...
            case INGESTION_SEND_NOTIFICATION_OK -> emailTemplatesConfiguration.getSendNotificationFlow().getOk();
            case INGESTION_SEND_NOTIFICATION_KO -> emailTemplatesConfiguration.getSendNotificationFlow().getKo();
