...
public class TransferClassificationService {
	 ...
	 */
	public List<ClassificationsEnum> defineLabels(Transfer transferDTO, PaymentsReporting paymentsReportingDTO, TreasuryIuf treasuryIuf, TreasuryIuv treasuryIuv) {
		List<ClassificationsEnum> labels = classifiers.stream()
			.map(classifier -> classifier.classify(transferDTO, paymentsReportingDTO, treasuryIuf, treasuryIuv))
