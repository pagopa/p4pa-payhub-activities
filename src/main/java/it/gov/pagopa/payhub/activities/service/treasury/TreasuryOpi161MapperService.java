...
@Lazy
@Service
public class TreasuryOpi161MapperService implements BiFunction<FlussoGiornaleDiCassa, IngestionFlowFileDTO, TreasuryDTO> {
    ...
    public TreasuryDTO apply(FlussoGiornaleDiCassa flussoGiornaleDiCassa, IngestionFlowFileDTO ingestionFlowFileDTO) {
        ...
        return TreasuryDTO.builder()
          .codIdUnivocoFlusso(ingestionFlowFileDTO.getIuf())
