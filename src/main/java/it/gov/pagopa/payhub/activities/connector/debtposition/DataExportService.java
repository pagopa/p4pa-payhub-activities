...
public interface DataExportService {
     ...
     *
     * @param paidInstallmentsRequestDTO The DTO containing the request parameters (required)
     * @param page Zero-based page index (0..N) (optional, default to 0)
     * @param size The size of the page to be returned (optional, default to 20)
     * @param sort Sorting criteria in the format: property,(asc|desc). Default sort order is ascending. Multiple sort criteria are supported. (optional)
     * @return PagedInstallmentsPaidView
     */
    PagedInstallmentsPaidView exportPaidInstallments(PaidInstallmentsRequestDTO paidInstallmentsRequestDTO, Integer page, Integer size, List<String> sort);
}
