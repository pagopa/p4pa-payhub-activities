package it.gov.pagopa.payhub.activities.config.json.jackson3;

import it.gov.pagopa.payhub.activities.config.json.LocalDateTimeToOffsetDateTimeDeserializer;
