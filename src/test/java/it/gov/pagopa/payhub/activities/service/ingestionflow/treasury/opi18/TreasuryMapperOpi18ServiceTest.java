...
import it.gov.pagopa.payhub.activities.xsd.treasury.opi18.TestataMessaggio;
...
class TreasuryMapperOpi18ServiceTest {
    ...
    private TreasuryMapperOpi18Service treasuryMapperService;


    @BeforeEach
    void setUp() {
        treasuryMapperService = new TreasuryMapperOpi18Service();
    }

    @Test
    void givenValidInputWhenApplyThenCorrectResult() throws Exception {
    ...
    @Test
    void givenTestataInputWithBlankValueWhenApplyThenCorrectResult() throws Exception {
        FlussoGiornaleDiCassa flussoGiornaleDiCassa = createFGC();
        TestataMessaggio testataMessaggio = new TestataMessaggio();
        flussoGiornaleDiCassa.getTestataMessaggio().add(testataMessaggio);
