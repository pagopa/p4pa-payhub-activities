...
class PaymentsReporting2ReceiptMapperTest {
	...
	void testMapper() {
		...
		TestUtils.checkNotNullFields(receipt, "receiptId", "paymentNote", "officeName", "pspPartitaIva", "paymentMethod", "feeCents", "sourceFlowName", "creationDate", "updateDate", "rtFilePath");
