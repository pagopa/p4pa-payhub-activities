	...
	void givenNullTransferDTOWhenSaveAllThenReturnSavedList() {
		...
		List<Classification> dtoList = List.of(
			Classification.builder()
				...
				.installmentIngestionFlowFileName(null)
				.receiptOrgFiscalCode(null)
				.receiptPaymentReceiptId(null)
				.receiptPaymentDateTime(null)
				.receiptPaymentRequestId(null)
				.receiptIdPsp(null)
				.receiptPspCompanyName(null)
				.organizationEntityType(null)
				.organizationName(null)
				.receiptPersonalDataId(null)
				.receiptPaymentOutcomeCode(null)
				.receiptPaymentAmount(null)
				.receiptCreditorReferenceId(null)
				.transferAmount(null)
