...
| INGESTION_FLOW_FILES_DP_TYPE_MAX_CONCURRENT_PROCESSING_ROWS               | Maximum number of rows to process concurrently during DEBT_POSITIONS_TYPE ingestion                                                            | ${INGESTION_FLOW_FILES_DEFAULT_MAX_CONCURRENT_PROCESSING_ROWS} |
| INGESTION_FLOW_FILES_DP_TYPE_ORG_MAX_CONCURRENT_PROCESSING_ROWS           | Maximum number of rows to process concurrently during DEBT_POSITIONS_TYPE_ORG ingestion                                                        | ${INGESTION_FLOW_FILES_DEFAULT_MAX_CONCURRENT_PROCESSING_ROWS} |
...
| INGESTION_FLOW_FILES_ORG_SIL_SERVICES_MAX_CONCURRENT_PROCESSING_ROWS      | Maximum number of rows to process concurrently during ORGANIZATIONS_SIL_SERVICE ingestion                                                      | ${INGESTION_FLOW_FILES_DEFAULT_MAX_CONCURRENT_PROCESSING_ROWS} |
| INGESTION_FLOW_FILES_PAYMENT_NOTIFICATIONS_MAX_CONCURRENT_PROCESSING_ROWS | Maximum number of rows to process concurrently during PAYMENT_NOTIFICATION ingestion                                                           | ${INGESTION_FLOW_FILES_DEFAULT_MAX_CONCURRENT_PROCESSING_ROWS} |
| INGESTION_FLOW_FILES_RECEIPTS_MAX_CONCURRENT_PROCESSING_ROWS              | Maximum number of rows to process concurrently during RECEIPT ingestion                                                                        | ${INGESTION_FLOW_FILES_DEFAULT_MAX_CONCURRENT_PROCESSING_ROWS} |
