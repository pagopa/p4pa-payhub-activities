...
tasks.register<GenerateTask>("openApiGenerateIONOTIFICATION") {
	...
	generatorName.set("java")
	remoteInputSpec.set("https://raw.githubusercontent.com/pagopa/p4pa-io-notification/refs/heads/P4ADEV-2361-get-api-key-to-send-messages/openapi/p4pa-io-notification.openapi.yaml")
	outputDir.set("$projectDir/build/generated")
