...
tasks.register<GenerateTask>("openApiGenerateDEBTPOSITIONS") {
	...
	generatorName.set("java")
	remoteInputSpec.set("https://raw.githubusercontent.com/pagopa/p4pa-debt-positions/refs/heads/P4ADEV-3144-add-field-action-to-installment/openapi/generated.openapi.json")
	outputDir.set("$projectDir/build/generated")
